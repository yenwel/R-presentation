...
========================================================
  ...
  * Script language for statistical programming
  * Open source
 ...
 * notable R packages:
   * dplyr and derivatives: high level data wrangling : https://cran.r-project.org/web/packages/dplyr/vignettes/dplyr.html
   
1.2 Checklist: Is R the tool for me right now?
========================================================
 * Do I want to use free (like beer) software : yes
 * Do I want to experiment with different models : yes 
